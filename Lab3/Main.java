        ...
        for (int ratioOption = 0; ratioOption < ratioArr.length; ratioOption++) {
            ...
            for (int threadOption = 0; threadOption < threadsArr.length; threadOption++) {
                for (int run = 0; run < runs; run++){
                    ...
                    long totalUniform = (System.nanoTime() - startUniform)/1000000; 
                    System.out.println("--Execution time uniform distribution for " + threadsArr[threadOption] + " threads: " + totalUniform);
                    ...
                    long totalNormal = (System.nanoTime() - startNormal)/1000000; 
                    System.out.println("--Execution time normal distribution for " + threadsArr[threadOption] + " threads: " + totalNormal);
                    System.out.println("");
                }
                System.out.println("-----");
            }
